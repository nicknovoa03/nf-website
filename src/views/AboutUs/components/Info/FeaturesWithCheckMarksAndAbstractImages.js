...
const FeaturesWithCheckMarksAndAbstractImages = () => {
  ...
  return (
    <Container data-aos={isMd ? 'fade-down' : 'fade-up'}>
          ...
          <Box>
            <Box marginBottom={2}>
              ...
              <Typography color="text.secondary">
                We believe the right tools and automation can help improve
                everyone's life. Whether you are a business owner or the very
                customer engaging with that business. We've built an all-in-one
                customer experience marketing platform to help your business
                with:
              </Typography>
            </Box>
